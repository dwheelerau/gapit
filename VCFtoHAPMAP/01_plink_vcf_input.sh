...
#NOTE: chr1 or chromosome_1 needs to be modified to 1, 
#and DONT USE --allow-extra-chr as it screws up the conversion
OUT='myplinkp1'
VCF='combined.freebayes.p1.annot.q30.chmfix.vcf'
PHENO='trait_dot_plink.txt'

plink --recode12 --vcf $VCF \
 --pheno $PHENO --allow-no-sex --out $OUT
